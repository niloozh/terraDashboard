  ...
  return (
    <>
      ...
      <MobNav
        type="flex"
        className={cx(
          'w-px-300 text-center bgThemeOne boxShadowType1 transition1 HeaderMobNavContainerZIndex'
        )}
        ...
        {MENU_ITEMS?.map((item, idx) => (
          <Anchor href={item.to} key={idx} anchorType={0}>
            <MobNavItem
              ...
              className="p2 mouse-hand textWhite hover-text-pink boxShaodwType1"
